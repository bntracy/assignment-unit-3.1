...
let favoriteFoods = ['potato dumplings', 'fresh walleye', 'sour cream and onion potato chips'];
...
console.log('lastAnimal, using .length property:', lastAnimal);
...
console.log('favoriteFoods after adding dessert:', favoriteFoods);
...
console.log('favoriteFoods after adding entree:', favoriteFoods);
...
console.log('Removed the last color, which was', lastColor);
